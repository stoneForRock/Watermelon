...
//    self.navigationBar.barStyle = UIBarStyleBlack;
    ...
    textAttrs[NSForegroundColorAttributeName] = self.titleTintColor;
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated {
    ...
    if (self.childViewControllers.count > 0) {
		...
		[backButton setTitleColor:self.titleTintColor forState:UIControlStateNormal];
		backButton.tintColor = self.titleTintColor;
