...
//! Project version number for QCMaterialDesignSpinner.
FOUNDATION_EXPORT double QCMaterialDesignSpinnerVersionNumber;

//! Project version string for QCMaterialDesignSpinner.
FOUNDATION_EXPORT const unsigned char QCMaterialDesignSpinnerVersionString[];
 ...
 */
@interface QCMaterialDesignSpinner : UIView
